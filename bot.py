...
TAGS = {
    "poses": {"doggy": "Наездница", "standing": "Стоя", "splits": "Шпагат", "squat": "Присед", "lying": "Лежа",
    ...
    "clothes": {"stockings": "Чулки", "heels": "Каблуки", "mask": "Маска", "shibari": "Шибари",
                "bikini_tan_lines": "Загар от бикини"},
    "body": {"big_breasts": "Большая грудь", "small_breasts": "Маленькая грудь", "body_thin": "Худое",
    ...
    "ethnos": {"ethnicity_asian": "Азиатка", "ethnicity_european": "Европейка", "futanari": "Футанари",
               "femboy": "Фембой"},
    "holes": {"vagina": "Вагина", "anal": "Анус", "both": "Вагина и анус"},
    "toys": {"dildo": "Дилдо", "huge_dildo": "Большое дилдо", "horse_dildo": "Лошадиное дилдо",
    ...
    "furry": {"furry_cow": "Фури корова", "furry_cat": "Фури кошка", "furry_dog": "Фури собака",
    ...
    "characters": {"rias": "Риас Гремори", "akeno": "Акено", "kafka": "Кафка", "eula": "Еола", "fu_xuan": "Фу Сюань",
                   "ayase": "Аясе Сейко", "2b": "2B", "yor": "Йор Форжер"},
    "head": {"ahegao": "Ахегао", "ecstasy_face": "Экстаз", "pain_face": "Боль", "gold_lipstick": "Золотая помада"},
    "view": {"view_top": "Сверху", "view_bottom": "Снизу", "view_side": "Сбоку", "view_close": "Близко",
             "view_full": "Полный рост"}
}

TAG_PROMPTS = {
    "rias": "red hair, blue eyes, rias gremory, large breasts", "akeno": "black hair, purple eyes, akeno himejima",
    "kafka": "purple wavy hair, honkai star rail, kafka", "eula": "blue hair, genshin impact, eula",
    "fu_xuan": "pink twin tails, honkai star rail, fu xuan", "ayase": "black hair, school uniform, ayase seiko",
    "2b": "white hair, blindfold, nier automata, 2b", "yor": "black hair, red eyes, spy x family, yor forger",
    ...
    "long_dildo_path": "dildo in anus, exiting mouth, belly bulge", "doggy": "doggy style", "standing": "standing",
    "splits": "split pose", "squat": "squatting", "lying": "lying down", "hor_split": "horizontal split",
    "ver_split": "vertical split", "side_up_leg": "on side, leg raised", "bridge": "arched bridge",
    "suspended": "suspended in ropes", "front_facing": "facing viewer", "back_facing": "back to viewer",
    "lying_knees_up": "knees up", "stockings": "black stockings", "heels": "red high heels", "mask": "face mask",
    "shibari": "shibari rope", "bikini_tan_lines": "bikini tan lines", "big_breasts": "large breasts",
    "small_breasts": "small breasts", "body_thin": "thin body", "body_fit": "fit body", "body_fat": "curvy body",
    "body_normal": "normal body", "skin_white": "white skin", "skin_black": "dark skin",
    "body_muscular": "muscular", "age_loli": "young girl", "age_milf": "mature woman", "age_21": "age 21 girl",
    "cum": "cum covered", "belly_bloat": "belly bulge", "succubus_tattoo": "succubus tattoo on belly",
    "futanari": "futanari girl", "femboy": "femboy", "ethnicity_asian": "asian girl",
    "ethnicity_european": "european girl", "furry_cow": "furry cow girl", "furry_cat": "furry cat girl",
    "furry_dog": "furry dog girl", "furry_dragon": "furry dragon girl", "furry_fox": "furry fox girl",
    "furry_bunny": "furry bunny girl", "furry_wolf": "furry wolf girl", "furry_sylveon": "furry sylveon",
    "ahegao": "ahegao", "ecstasy_face": "face in ecstasy", "pain_face": "face in pain", "gold_lipstick": "gold lipstick",
    "view_top": "from above", "view_bottom": "from below", "view_side": "side view", "view_close": "close-up",
    "view_full": "full body"
}
...
def callback(call):
    ...
    if data == "choose_tags":
        ...
        final_prompt = f"nsfw, masterpiece, anime style, best quality, fully nude, {prompt}"
